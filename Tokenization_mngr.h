...
public:
    ...
    // Token-Liste aus Datei laden mit Zugehörigkeit zu einer anderen Klasse (z.B. CPU-Modelle zu einer CPU-Marke)
    bool loadTokenList(const std::string &filename, token_class tk, token_class parent_tk)
    {
